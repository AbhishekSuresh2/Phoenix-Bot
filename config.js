...
//____________________________________________________________________________________________________________________________________________  
  SESSION_ID: process.env.SESSION_ID || 'Phoenix~AtomicVigilant',
  STICKER_DATA: process.env.STICKER_DATA || '🎯ꪜ𝔞𝔩𝔱𝔬𝔯𖠌-ᴍᴅ;ᴀʙʜɪꜱʜᴇᴋ ꜱᴜʀᴇꜱʜ🍀',
  ...
  BOT_INFO: process.env.BOT_INFO || 'ꪜ𝔞𝔩𝔱𝔬𝔯𖠌-ᴍᴅ;ᴀʙʜɪꜱʜᴇᴋ ꜱᴜʀᴇꜱʜ;919074692450;https://i.ibb.co/tHWJrz3/IMG-20231128-WA0005.jpg', 
  PREFIX: process.env.PREFIX || '!',
  MODE: process.env.MODE || 'private',
  SUDO: process.env.SUDO || '919074692450, 918157993101, 2347071118898',
