...
//____________________________________________________________________________________________________________________________________________  
  SESSION_ID: process.env.SESSION_ID || 'Pheonix~AtomicVigilant',
  STICKER_DATA: process.env.STICKER_DATA || '🎯ᦔ𝔞𝔩𝔱𝔬𝔯-ᴍᴅ;ᦔȇ̈ˢᵖᵉʳ🕷️',
  ALIVE_DATA: process.env.ALIVE_DATA || '👋 ʜᴇʏ &sender, ɪ ᴍ *ᦔ𝔞𝔩𝔱𝔬𝔯-ᴍᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ* ᴀʟɪᴠᴇ ɴᴏᴡ!\n\n📌 ᴛʏᴘᴇ *menu* ᴛᴏ ɢᴇᴛ ᴍʏ ᴄᴏᴍᴍᴀɴᴅ ʟɪꜱᴛ.\n\n*ᴘʟᴀᴛꜰᴏʀᴍ:* &platform\n*ʀᴜɴᴛɪᴍᴇ:* &runtime;https://ibb.co/TWpnJ0H',
  AUDIO_DATA: process.env.AUDIO_DATA || 'ᦔ𝔞𝔩𝔱𝔬𝔯-MD;ᦔȇ̈ˢᵖᵉʳ;https://ibb.co/TWpnJ0H',
  BOT_INFO: process.env.BOT_INFO || 'ᦔ𝔞𝔩𝔱𝔬𝔯-ᴍᴅ;ᦔȇ̈ˢᵖᵉʳ;2347071118898;https://ibb.co/TWpnJ0H', 
  PREFIX: process.env.PREFIX || '.',
  MODE: process.env.MODE || 'private',
  SUDO: process.env.SUDO || '2347059751569, 2347071118898',
  ...
  AUTO_STATUS_REPLY_MSG: process.env.AUTO_STATUS_REPLY_MSG || '_*Nice Status Bro 🕷️*_',
